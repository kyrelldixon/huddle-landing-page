export default () => (
  <header className="relative bg-center bg-no-repeat bg-cover bg-cyan-light bg-mobile lg:bg-desktop">
    <nav className="flex items-center justify-between px-4 py-6 md:px-8 lg:px-12 lg:mb-4">
    ...
    <div className="flex flex-col items-center px-8 pt-16 pb-8 text-center md:pb-12 md:pt-8 md:text-left md:flex-row lg:pb-12 lg:px-12 lg:pt-4 lg:text-left lg:flex-row">
      <div className="pr-8 mb-4 md:mb-0 md:mr-8 lg:mr-12">
