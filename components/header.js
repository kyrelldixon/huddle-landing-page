export default () => (
  <header className="relative bg-center bg-no-repeat bg-cover bg-cyan-light bg-mobile lg:bg-desktop">
    ...
    <div className="flex flex-col items-center px-8 pt-16 pb-8 text-center md:pb-12 md:pt-8 md:text-left md:flex-row lg:pb-20 lg:px-12 lg:pt-4 lg:text-left lg:flex-row">
